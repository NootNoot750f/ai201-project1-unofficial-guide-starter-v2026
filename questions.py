...
QUESTIONS = [
    # {"question": "...", "expects": "..."},
    {"question": "What is the course load from Data Structures", "expects": "hours, problem sets, exams"},
    {"question": "What is the course load from Databases", "expects": "hours, problem sets, exams"},
    {"question": "What is the course load from Cell Biology", "expects": "hours, problem sets, exams"},
    {"question": "What is the amount of time I need to work on Cell Biology a week", "expects": "hours"},
    {"question": "Why do people in China speak Chinese", "expects": "I don't have enough information"},
]
