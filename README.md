...
<!-- What about YOUR documents made you pick these numbers? Short posts and
     ...
     Posts in campus_life are atomic units of 1–3 paragraphs. Each one is a

self-contained thought: "wait times at Halden Hall" or "add/drop deadline rules."
Splitting them would fragment the idea. Keeping them whole lets retrieval find
complete answers, and evaluation in Milestone 3 confirms each chunk stands alone.
...
# **Chunk 4** — source: `dining_pellew_dining_hall_followup` — produced by: `chunker.py::split_documents`
